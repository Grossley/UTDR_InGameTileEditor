baseline_file = argument0
overwrite_file = argument1
loaded = 0
loaded_background = 0
loaded_left = 0
loaded_top = 0
...
baseline_fileid = file_text_open_read(baseline_file)
while (!file_text_eof(baseline_fileid))
{
    file_text_readln(baseline_fileid)
    background_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    left_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    top_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    width_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    height_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
    xscale_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    yscale_to_strip = real(file_text_read_string(baseline_fileid))
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
    file_text_readln(baseline_fileid)
...
file_text_close(baseline_fileid)
